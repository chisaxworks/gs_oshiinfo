...
class Tvtx02Spider(CrawlSpider):
    name = "tvtx02"
    allowed_domains = ["www.tv-tokyo.co.jp"]
    # start_urls = ["https://www.tv-tokyo.co.jp/timetable/broad_tvtokyo/nextweek"]
    ...
    def start_requests(self):
        url = "https://www.tv-tokyo.co.jp/timetable/broad_tvtokyo/nextweek"
